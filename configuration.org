...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package lsp-python-ms
    :straight (:host github :repo "linw1995/lsp-python-ms")
...
Create a =.dir-locals.el= file with the below code in the root directory of each project/worksplace.  And you can modify the string value that is absolute path of the Python executable.

#+BEGIN_SRC emacs-lisp :tangle no
  ((python-mode
    . ((lsp-python-ms-python-executable . "{absolute path of the Python executable}")))
#+END_SRC

If you use poetry to manage project, you can copy the below code instead. It will check and configure with venv created by poetry.
