...
#+BEGIN_SRC emacs-lisp
  (use-package tsc
    :straight (:type git :host github :repo "ubolonton/emacs-tree-sitter" :files ("core/*.el")))

  (use-package tree-sitter
    :straight
    (:type git :host github :repo "ubolonton/emacs-tree-sitter" :files ("lisp/*.el"))
    :hook
  ...
  (use-package tree-sitter-langs
    :straight
    (:type git :host github :repo "ubolonton/emacs-tree-sitter" :files ("langs/*.el" "langs/queries")))
#+END_SRC
