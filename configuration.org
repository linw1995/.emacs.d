...
#+BEGIN_SRC emacs-lisp
  (use-package tree-sitter
    :straight
    (:host github :repo "ubolonton/emacs-tree-sitter" :files ("lisp/*.el"))
    :hook
    ((python-mode . tree-sitter-hl-mode)))

  (use-package tree-sitter-langs
    :straight
    (:host github :repo "ubolonton/emacs-tree-sitter" :files ("langs/*.el" "langs/queries")))
#+END_SRC
...
Create a =.dir-locals.el= file with the below code in the root directory of each project/worksplace.
And you can modify the string value that is absolute path of the Python executable.
...
I add a hooking to set it by default via =poetry=.
